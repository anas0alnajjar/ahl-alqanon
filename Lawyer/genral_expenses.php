...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true" style="text-align: right; direction: rtl;">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
                                ...
                                <?php
                                    ...
                                    if (!empty($OfficeId)) {
                                        ...
                                        $sql_types = "SELECT DISTINCT ct.id, ct.type 
                                                    FROM costs_type ct
                                                    WHERE ct.office_id IN ($OfficeId) OR ct.public = 1
                                                    ORDER BY ct.id DESC";
            ...
            <div class="modal-footer">
                ...
                <button id="saveExpe" type="button" class="btn btn-primary expenses-add">حفظ</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="filters row g-3 d-flex flex-wrap">
        ...
        <div class="col-12 col-md-4 mb-2 align-self-end" >
            <div class="btn-group w-100" role="group" aria-label="Basic example" style="direction:ltr;">
                <button type="button" class="btn btn-dark btn-md expenses-add" id="add_expense_btn">اضافة بند</button>
                                ...
                                <table id="records" class="display responsive nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th></th>
                                            <th></th>
                                            <th class="expenses-delete">الاجراءات</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
    ...
    <script src="../js/script_expenses_offices.js"></script>
