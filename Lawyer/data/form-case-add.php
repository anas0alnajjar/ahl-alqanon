                    ...
                    <div id="collapse55" class="collapse show" data-parent="#accordionMain">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <input type="hidden" value="<?=$user_id?>" name="lawyer_id" id="lawyer_id">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select id="client_id" class="" name="client_id" required>
                                            ...
                                            if (!empty($user_id)) {
                                                ...
                                                $sql_clients = "SELECT * FROM clients WHERE lawyer_id = $user_id ORDER BY clients.client_id";
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="defendant" class="" name="defendant[]" multiple>
                                        ...
                                        if (!empty($OfficeId)) {
                                            ...
                                            $sql = "SELECT * FROM adversaries WHERE lawyer_id = :lawyer_id ORDER BY id DESC";
