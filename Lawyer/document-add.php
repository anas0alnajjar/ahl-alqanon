...
<div class="container mt-5">
    ...
    <form method="post" class="shadow p-3 form-w" action="req/document-add.php" enctype="multipart/form-data" id="documentForm">
        ...
        <div class="row">
            ...
            <input type="hidden" name="lawer_name" id="lawers" value="<?=$user_id?>">
        ...
        <div class="mt-3 mb-3">
            ...
            <textarea id="notes" name="notes_for_doc" class="form-control"></textarea>
        </div>
        <div class="row">
