...
if (isset($_SESSION['user_id']) && isset($_SESSION['role'])) {
    ...
    if ($_SESSION['role'] == 'Lawyer') {
        ...
        if (isset($_POST['fname']) &&
            ...
            client_passport=?, role_id=?, `stop`=?, office_id=?, stop_date=? ";

            $params = [$fname, $lname, $address, $gender, $city, $email_address, $date_of_birth, $phone, $father_name, $grandfather_name, $national_num, $alhi, $street_name, $num_build, $num_unit, $zip_code, $subnumber, $receive_whatsupp, $receive_emails, $client_passport, $role_id, $stop_account, $office_id, $stop_date];
