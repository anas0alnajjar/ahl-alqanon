...
if (isset($_SESSION['user_id']) && isset($_SESSION['role']) && $_SESSION['role'] == 'Lawyer') {
    ...
    if (!empty($OfficeId)) {
        ...
        $sql = "SELECT courts.*, offices.office_name FROM courts INNER JOIN offices ON courts.office_id = offices.office_id WHERE courts.office_id IN ($OfficeId) OR public = 1";
    ...
    <table class="table table-responsive mt-3 n-table">
        <thead>
            <tr>
                ...
                <th scope="col" style="font-weight:700;">المحكمة</th>
