                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><strong>الاسم:</strong> <?= htmlspecialchars($lawyer['lawyer_name'] ?? '', ENT_QUOTES, 'UTF-8') ?></li>
                            ...
                            <a href="edit-profile.php?lawyer_id=<?=$lawyer_id?>" class="btn btn-primary btn-sm w-100">تعديل</a>
