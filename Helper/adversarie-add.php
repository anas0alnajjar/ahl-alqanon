...
<body>
    <?php 
     ...
     <div class="btn-group mb-3" style="direction:ltr;">
        ...
        <form method="post" class="shadow p-3 form-w" action="req/adversary-add.php" id="adversaryForm">
            ...
            <div class="row">
                ...
                <input type="hidden" id="lawyer_id" class="form-control" value="<?=$lawyer_id?>" name="lawyer_id">
                <div class="col-md-6 mb-3">
    ...
    <script>
document.getElementById('adversaryForm').addEventListener('submit', function(event) {
        ...
        .then(data => {
            if (data.success) {
                Swal.fire({
                    ...
                    window.location.href = 'adversaries.php';
                });
            } else {
                Swal.fire({
                    icon: 'error',
