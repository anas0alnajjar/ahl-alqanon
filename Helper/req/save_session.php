...
try {
    ...
    if (isset($_SESSION['user_id']) && isset($_SESSION['role']) && $_SESSION['role'] == 'Helper') {
        ...
        $sql = "INSERT INTO sessions (case_id, session_number, session_date, session_hour, session_date_hjri, notes) 
                VALUES (:case_id, :session_number, :session_date_gregorian, :session_hour, :session_date_hijri, :notes)";
