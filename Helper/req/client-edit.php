...
if (isset($_SESSION['user_id']) && isset($_SESSION['role'])) {
    ...
    if ($_SESSION['role'] == 'Helper') {
        ...
        if (isset($_POST['fname']) &&
            ...
            $params = [$fname, $lname, $address, $gender, $city, $email_address, $date_of_birth, $phone, $father_name, $grandfather_name, $national_num, $alhi, $street_name, $num_build, $num_unit, $zip_code, $subnumber, $receive_whatsupp, $receive_emails, $client_passport];
