...
if (isset($_SESSION['user_id']) && isset($_SESSION['role']) && $_SESSION['role'] == 'Helper') {
    ...
    if (isset($_POST['event_name']) && isset($_POST['event_start_date']) && isset($_POST['event_end_date']) && isset($_POST['lawer_name']) && isset($_POST['client_name'])) {
        ...
        try {
            $insert_query = "INSERT INTO events (event_name, event_start_date, event_end_date, lawyer_id, client_id, helper_id) VALUES (:event_name, :event_start_date, :event_end_date, :lawer_name, :client_name, :helper_id)";
