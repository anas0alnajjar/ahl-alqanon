                            ...
                            <select id="client_name" class="form-select" name="client_name">
                                ...
                                <?php
                                    if ($user_id !== null) {
                                        ...
                                        $sqlClients = "SELECT DISTINCT cl.client_id, cl.first_name, cl.last_name 
                                                       FROM clients cl 
                                        ...
                                        $stmtClients->bindParam(':helper_id', $user_id, PDO::PARAM_INT);
                                        $stmtClients->execute();
        ...
        <div class="p-6">
            <div class="flex flex-col lg:flex-row gap-6 mb-6">
                ...
                <div class="lg:flex-1 grid grid-cols-1 md:grid-cols-2 gap-6" style="">
                    ...
                    <!-- Card 4 -->
                    <div class="custom-card card-6" data-count="<?php echo $monthly_costs_result['monthly_costs']; ?>" data-text="مصاريف الجلسات للشهر الحالي">
                        <div class="flex justify-between mb-4">
                            <div>
