...
<body>
    ...
    <div class="btn-group mb-3" style="direction:ltr;">
            ...
            <a href="document-add.php" class="btn btn-dark">اضافة عقد/وثيقة جديدة</a>
            <?php endif; ?>
    </div>
    ...
    <?php if (isset($_GET['success'])) { ?>
        ...
        <thead>
            <tr>
                <th>ID</th>
                <th>عنوان العقد/المستند</th>
                <th>اسم الموكل</th>
                <th>تفاصيل المستند /العقد</th>
                <th>الاجراءات</th>
            </tr>
        </thead>
        <tbody>
    ...
    <script>var hideingColumn = 1; </script>
    <script src="../js/script_documents_users.js"></script>
