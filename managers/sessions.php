...
$clients = getClients($conn, $office_id);
$lawyers = getLawyers($conn, $office_id);

function getCases($conn, $office_id) {
...
if (isset($_SESSION['user_id']) && isset($_SESSION['role']) && $_SESSION['role'] == 'Managers') {
    ...
    $total_records_stmt->bindValue(':office_id', $office_id, PDO::PARAM_INT);
