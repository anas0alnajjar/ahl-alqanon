...
if (isset($_SESSION['user_id']) && isset($_SESSION['role'])) {
    if ($_SESSION['role'] == 'Managers') {
        ...
        function getClients($conn, $office_id) {
        ...
        function getLawyers($conn, $office_id) {
        ...
        $clients = getClients($conn, $OfficeId);
        $lawyers = getLawyers($conn, $OfficeId);
        ...
        $count_stmt->bindParam(':office_id', $OfficeId, PDO::PARAM_INT);
        if (!empty($search)) {
                                ...
                                <div class="todo-item border p-3 mb-2 rounded" style="direction:rtl;text-align:right;">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <div>
                                            ...
                                            <?php } ?>
                                            <span class="task-title <?php echo $todo['read_by_manager'] ? 'checked' : ''; ?> mb-0">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="helper_name" class="form-select" name="helper_id">
                            ...
                            <?php
                                ...
                                $stmt_helpers->bindParam(':office_id', $OfficeId, PDO::PARAM_INT);
