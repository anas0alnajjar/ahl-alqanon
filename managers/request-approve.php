        ...
        if ($user_data) {
            try {
                ...
                if ($user_data['as_a'] == 1) {
                    ...
                    $sql_insert_client = "INSERT INTO clients (first_name, last_name, email, phone, username, `password`, `address`, gender, date_of_birth, city, role_id, office_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                    ...
                    $sql_insert_lawyer = "INSERT INTO lawyer (lawyer_name, date_of_birth, lawyer_email, lawyer_phone, username, lawyer_password, lawyer_address, lawyer_gender, lawyer_city, role_id, office_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
