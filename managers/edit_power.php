...
if (isset($_SESSION['user_id']) && isset($_SESSION['role']) && $_SESSION['role'] == 'Managers') {
    ...
    try {
        ...
        if ($id) {
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                $selected_lawyers = !empty($row['lawyer_id']) ? explode(',', $row['lawyer_id']) : [];
            }
        } else {
    ...
    $editPages = [
        ...
        'expenses' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        ...
        'lawyers' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'clients' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'assistants' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'expense_types' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'courts' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'case_types' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'judicial_circuits' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'documents' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'notifications' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'message_customization' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'outbox' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'roles' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'logo_contact' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'user_management' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'adversaries' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
        'profiles' => ['read' => 0, 'write' => 0, 'add' => 0, 'delete' => 0, 'permission_id' => null],
    ];
                ...
                if (!empty($OfficeId)) {
                    ...
                    if ($stmt_lawyers->rowCount() > 0) {
                        while ($row = $stmt_lawyers->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            $selected = in_array($lawyer_id, $selected_lawyers) ? "selected" : "";
