                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="client_id" class="" name="client_id" required>
                                            ...
                                            if (!empty($OfficeId)) {
                                                ...
                                                $sql_clients = "SELECT * FROM clients WHERE office_id IN ($OfficeId) ORDER BY clients.client_id";
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <?php
                                            ...
                                            if (!empty($OfficeId)) {
                                                $sql = "SELECT * FROM clients WHERE office_id IN ($OfficeId) ORDER BY clients.client_id DESC";
                                                $result = $conn->query($sql);
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="defendant" class="" name="defendant[]" multiple>
                                        ...
                                        if (!empty($OfficeId)) {
                                            ...
                                            $sql = "SELECT * FROM adversaries WHERE office_id = :office_id ORDER BY id DESC";
