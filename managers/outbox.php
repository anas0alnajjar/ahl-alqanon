...
if (isset($_SESSION['user_id']) && isset($_SESSION['role']) && $_SESSION['role'] == 'Managers') {
    ...
    $notifications = getAllNotifications($conn, $OfficeId);
    $reminders = getAllReminders($conn, $OfficeId);
    $cases = getAllCases($conn, $OfficeId);
    $tasks = getAllTasks($conn, $OfficeId);
    $helpers = getHelpers($conn, $OfficeId);
