                    ...
                    <div class="flex flex-col lg:flex-row gap-6 mb-6">
                        ...
                        <div class="lg:flex-1 grid grid-cols-1 md:grid-cols-2 gap-6" style="">
                            ...
                            <div class="custom-card card-6" data-count="<?php echo $monthly_costs_result['monthly_costs']; ?>"
                                data-text="المصروفات للشهر الحالي">
                                <div class="flex justify-between mb-4">
                                    <div>
                                ...
                                <a href="genral_expenses.php" class="text-white font-medium text-sm hover:text-gray-200">صفحة
                                    المصروفات</a>
                            </div>

                            <!-- Card 5 -->
                            <div class="custom-card card-5"
                                data-count="<?php if (isset($monthly_payment_result['monthly_paid']) && $monthly_payment_result['monthly_paid'] > 0) {
                            ...
                            <!-- Card 6 -->
                            <div class="custom-card card-5"
                                data-count="<?php echo ($monthly_payment_result_total['monthly_paid'] - $monthly_costs_result['monthly_costs']); ?>"
                                data-text="الأرباح/العجز للشهر الحالي">
                                <div class="flex justify-between mb-4">
                                    <div>
                                        <i style="position: absolute;left: 10px;"
                        ...
                        <div
                            class="lg:flex-1 card card-primary shadow-lg rounded-md overflow-hidden h-full flex flex-col collapsed-card">
                                        ...
                                        <div class="lg:flex-1" id="calendar-container"
                                            ...
                                            <div class="bg-gray-50 border border-gray-200 shadow-md p-4 rounded-md h-full">
                                                <div class="w-full h-full flex flex-col">
                                                    ...
                                                    <button id="openDateRangePicker"
                                                        class="btn btn-primary btn-sm mb-2 w-full">طباعة
                                                        الأجندة</button>
                                                    <div id="calendar"
                                                        class="w-full flex-grow border-t border-gray-200 mt-2 pt-2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
