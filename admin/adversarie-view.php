...
<div class="container mt-5" style="direction: rtl;">
    <div class="card shadow-sm" style="max-width: 32rem;">
        ...
        <div class="card-body">
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    المكتب:
                    <?php
                        $stmt = $conn->prepare("SELECT office_name FROM offices WHERE office_id = :id");
                        $stmt->execute(['id' => $adver['office_id']]);
                        $office_name = $stmt->fetchColumn();
                        echo htmlspecialchars($office_name ?? '', ENT_QUOTES, 'UTF-8');
                    ?>
                </li>
        ...
        <div class="card-footer text-center">
            <a href="adversaries.php" class="btn btn-secondary">العودة</a>
        </div>
    </div>
</div>
