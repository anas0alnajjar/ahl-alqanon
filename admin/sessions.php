                ...
                <form id="sessionForm">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control geo-date-input" name="session_date_gregorian" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label>تاريخ الجلسة هجري</label>
                            <input type="text" class="form-control hijri-date-input" name="session_date_hijri" required autocomplete="off">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
