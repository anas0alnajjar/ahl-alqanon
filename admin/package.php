        ...
        <head>
            ...
            <style>
                * {
                ...
                .btn-submit:hover, .btn-danger:hover {
        ...
        <body>
            ...
            <div class="container-fluid mt-5" style="max-width: 90%;">
                ...
                ?>
                    <div class="container">
                        <form action="req/add_package.php" method="POST">
                            <div class="form-container col-md-12 mx-auto">
                                <h2 class="form-title">عرض باقة </h2>

                                <!-- الصف الأول: اسم الباقة و وصف الباقة -->
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="planName">اسم الباقة</label>
                                        <input type="text" class="form-control" id="planName" name="plan_name" value="<?= $package['name'] ?>" disabled>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="planDescription">وصف الباقة</label>
                                        <textarea class="form-control" id="planDescription" name="plan_description" rows="2" disabled><?= $package['description'] ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="<?php if ($package['status'] == 1) echo 'مفعلة';
                                                                                        else if ($package['status'] == 0) echo 'غيرمفعلة';  ?>" disabled>


                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="planDuration">مدة الباقة</label>
                                        <input type="text" class="form-control" value="<?php if ($package['duration'] == 1) echo 'شهر';
                                                                                        else if ($package['duration'] == 2) echo 'سنة';  ?>" disabled>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="planPrice" name="plan_price" value="<?= $package['price'] ?>" disabled>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="planCategory">فئة الباقة</label>
                                        <input type="text" class="form-control" id="planCategory" value="<?php if ($package['category'] == 1) echo 'محامين';
                                                                                                            else if ($package['category'] == 2) echo 'مكاتب';
                                                                                                            else if ($package['category'] == 3) echo 'شركات' ?>" disabled>
                                ...
                                <div id="servicesSection">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" class="form-control" id="numCases" name="num_cases" value="<?= $package['num_cases'] ?>" disabled>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="numClients">عدد الموكلين</label>
                                            <input type="number" class="form-control" id="numClients" name="num_clients" value="<?= $package['num_clients'] ?>" disabled>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="numHelpers">عدد الإداريين</label>
                                            <input type="number" class="form-control" id="numHelpers" name="num_helpers" value="<?= $package['num_helpers'] ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="numMessages">عدد الرسائل</label>
                                            <input type="text" class="form-control" id="numMessages" name="num_messages" value="<?= $package['num_messages'] ?>" disabled>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="numDocuments">عدد الوثائق</label>
                                            <input type="number" class="form-control" id="numDocuments" name="num_documents" value="<?= $package['num_documents'] ?>" disabled>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="numTasks">عدد المهام</label>
                                            <input type="number" class="form-control" id="numTasks" name="num_tasks" value="<?= $package['num_tasks'] ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="numSessions">عدد الجلسات</label>
                                            <input type="number" class="form-control" id="numSessions" name="num_sessions" value="<?= $package['num_sessions'] ?>" disabled>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="numEvents">عدد الأحداث</label>
                                            <input type="number" class="form-control" id="numEvents" name="num_events" value="<?= $package['num_events'] ?>" disabled>
                                        </div>
                                ...
                                <a href="package-edit.php?id=<?= $package['id'] ?>" class="btn btn-submit ">تعديل</a>
                                <a href="delete_package.php?id<?=$package['id'] ?>" class="btn btn-danger ">حذف</a>
                            </div>
                        </form>
                    ...
                    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js"></script>
                    <script>
                        /* document.getElementById('planCategory').addEventListener('on', function() {
