...
<body>
    ...
    <div class="btn-group mb-3" style="direction:ltr;">
        ...
        <a href="users.php" class="btn btn-dark">إدارة المستخدمين</a>
    </div>
                    ...
                    <div class="mb-3 form-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="role_id" class="form-select" name="role_id">
                                ...
                                <?php
                                    $sql = "SELECT `power_id`, `role`, `default_role_manager` FROM powers";
                                    ...
                                    if ($result->rowCount() > 0) {
                                        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            $selected = ($default_role_manager == 1) ? "selected" : "";
