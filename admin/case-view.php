...
<div class="container-fluid mt-5" style="max-width: 90%;">
    ...
    <form class="" method="POST" action="" enctype="multipart/form-data" id="formEdit">
        ...
        <?php
                        ...
                        <div id="collapse9" class="collapse show" aria-labelledby="heading9" data-parent="#accordionMain" style="">
                            <div class="card-body" style="display:flex;">
                                <div class="column" style="min-width:25%">
                                    <div class="row">
                                        <button style="text-align: right;" id="editClientBtn" type="button" class="btn btn-link">معلومات الموكل</button>
                                        <button type="button" style="text-align: right;" class="btn btn-link" id="addHelper">إضافة إداري</button>
                                        <button id="editDocBtn" style="text-align: right;" type="button" class="btn btn-link">العقود</button>
                                    </div>
                                </div>
                                <div class="column" style="min-width:25%">
                                    <div class="row">
            ...
            <div class="tab-content mt-1" id="attachTab">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                                                ...
                                                                <div id="' . $collapseIdFile . '" class="collapse" data-parent="#dynamic_cards_files">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="text-center">
                                                                            <button type="button" style="min-width:100%;" class="btn btn-danger btn-sm btn-block deleteFileBtn" onclick="deleteFile(this)">حذف</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <button style="width: 25%; float:left;" type="button" id="addFiles1" class="btn btn-dark btn-sm m-2">إضافة مرفقات</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="tab-content mt-1" id="sessionsTab">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3" style="max-width: 100%; overflow-x: auto; scrollbar-width: thin; max-height: 600px; min-height: 400px;">
                                            <div id="dynamic_cards" class="row">
                                                ...
                                                $sql_lawyers = "SELECT lawyer_id, lawyer_name FROM lawyer";
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control form-control-sm" name="assistant_lawyer[]">
                                                                        <option value="">اختر محامي مساعد</option>';
                                                                ...
                                                                <button type="button" style="min-width: 100%;" class="btn btn-danger btn-sm btn-block deleteCardBtn" data-session-id="' . htmlspecialchars($session["sessions_id"]) . '">حذف</button>
                                                            </div>
                                                        </div>
                                                    </div>';
                                                }
                                        ...
                                        <button style="min-width: 15%; float: left;" type="button" id="addRowBtn" class="btn btn-dark btn-sm">إضافة جلسة</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="tab-content mt-1" id="expayTab">
                <div class="tab-pane fade show" id="expay-info" role="tabpanel" aria-labelledby="expay-info-tab">
                    <div class="card" id="expensesInfo">
                        <div id="heading3" class="card-header">
                            <h2 class="mb-0">
                        ...
                        <div id="collapse96" class="collapse show" data-parent="#accordionMain">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                                    ...
                                                    <div class="card h-100 shadow-sm">
                                                        ...
                                                        <div id="' . $collapseId . '" class="collapse" data-parent="#dynamic_cards_expenses">
                                                            <div class="card-body">
                                                                ...
                                                                <button style="min-width:100%;" type="button" class="btn btn-danger btn-sm btn-block deleteExpenses" data-expenses-id="' . htmlspecialchars($expense["id"]) . '">حذف</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>';
                                        ...
                                        <button style="min-width: 15%; float: left;" type="button" id="addExpenses" class="btn btn-dark btn-sm m-2">إضافة بند</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card" id="paymentInfo">
                        ...
                        <div id="collapse300" class="collapse show" data-parent="#accordionMain">
                            <div class="card-body">
                                            ...
                                            <div id="dynamic_cards_payment" class="row">
                                                ...
                                                foreach ($payments as $index => $payment) {
                                                    ...
                                                    if ($payment['received'] !== 1) {
                                                        ...
                                                        echo '<button style="min-width:49%" type="button" class="btn btn-danger btn-sm deletePayment" data-payment-id="' . htmlspecialchars($payment["id"]) . '">حذف</button>';
                                                    } else {
                                                        echo '<button style="min-width:100%" type="button" class="btn btn-danger btn-sm btn-block deletePayment" data-payment-id="' . htmlspecialchars($payment["id"]) . '">حذف</button>';
                                                    }
                                ...
                                <button style="min-width: 15%; float: left;" type="button" id="addPayment" class="btn btn-dark btn-sm m-2">إضافة دفعة</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <button type="button" class="btn btn-primary mb-3" id="editCase"> حفظ التعديلات </button>
            <button type="button" class="btn btn-danger mb-3" id="deleteCase">حذف</button>
    </form>
                ...
                <form method="post" class="shadow p-3 mt-4" id="clientEdit" action="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="office_idModal" class="form-control" name="office_idClient" required>
                                <option value="" disabled selected>اختر المكتب</option>
                                <?php
                                    $sql = "SELECT `office_id`, `office_name` FROM offices";
                                    $resultOffice = $conn->query($sql);
                                    if ($resultOffice->rowCount() > 0) {
                                        while ($rowOffice = $resultOffice->fetch(PDO::FETCH_ASSOC)) {
                                            $idOffice = $rowOffice["office_id"];
                                            $office_name = $rowOffice["office_name"];
                                            $selected = ($idOffice == $client_info['office_id'])? "selected" : "";
                                            echo "<option value='$idOffice' $selected>$office_name</option>";
                                        }
                                    }
                                ?>
                            </select>
        ...
        <div class="card">
            ...
            <div id="collapse1" class="collapse show" data-parent="#accordionMain">
                ...
                <div class="modal-footer">
                    ...
                    <button id="editClient" type="submit" class="btn btn-success">تحديث</button>  
                </div>
                </form>
            </div>
        </div>
    ...
    <!-- نهاية قسم الوثائق -->
                ...
                <div class="modal-footer">
                    ...
                    <button id="addDocBtn" type="button" class="btn btn-primary" data-dismiss="modal">إضافة</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                        ...
                        <button id="addReport" type="submit" class="btn btn-primary">إضافة</button>
                </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Add new element on button click
        ...
        newCard.innerHTML = `
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class="mb-2">المحامي المساعد</label>
                        <select class="form-control form-control-sm" name="assistant_lawyerNew[]">
                            ${lawyerOptions}
                        </select>
                    </div>
                    <div class="form-group">
        ...
        newCard.innerHTML = `
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class="mb-2">التاريخ ميلادي</label>
                        <input type="date" class="form-control form-control-sm geo-data-input" name="newPay[]" required>
                    </div>
                    <div class="form-group">
                        <label class="mb-2">التاريخ هجري</label>
                        <input type="text" class="form-control form-control-sm hijri-date-input" name="newPayHijri[]" required>
                    </div>
                    <div class="form-group">
                        <label class="mb-2">المبلغ</label>
