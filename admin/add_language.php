...
?>
        ...
        <body>
            ...
            <div class="container-fluid mt-5" style="max-width: 90%;">
                ...
                <form id="add-language-form" class="shadow p-3 mt-5" action="req/add-language.php" enctype="multipart/form-data" method="post">
                    <h3>إضافة لغة</h3>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="d-flex align-items-center">
                            <input type="checkbox" name="is_default" id="is_default_id" value="1">
