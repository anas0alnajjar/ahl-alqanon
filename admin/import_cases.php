...
<body>
    ...
    <div class="container">
        <div class="container-young">
            ...
            <div style="direction:ltr;" class="btn-group" role="group" aria-label="Data Actions">
                
                <button id="confirmInsert" class="btn btn-primary disabled">تأكيد وإدخال/تحديث البيانات</button>
                <form action="" method="POST">
                        <button id="clearButton" style="border-bottom-left-radius: 0px;border-top-left-radius: 0px;" type="submit"  name="clear_data" class="btn btn-secondary">مسح</button>
                </form>    
