        ...
        <div class="col-md-10 col-12">
            <div class="card h-100 shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <span>صور الهيدر</span>
                    <button id="add-image" class="btn btn-success btn-sm">
                    ...
                    <div id="image-container" class="d-flex overflow-auto" style="white-space: nowrap; scrollbar-width: none; -ms-overflow-style: none;">
                        ...
                        <?php foreach ($headers as $header): ?>
                            <div class="position-relative mx-2">
                                <img src="../../profiles_photos/<?php echo $header['header']; ?>" alt="Header Image" class="img-thumbnail hover-zoom" style="width: 100px; height: 100px;">
                                <button class="btn btn-danger btn-sm position-absolute" style="top: 0px; right: 0px;opacity: 0.7;" onclick="deleteImage('<?php echo $header['header']; ?>')">
                ...
                <?php
                    ...
                    if ($result->rowCount() > 0) {
                        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            $selected = $profile && $profile['office_id'] == $id ? 'selected' : '';
