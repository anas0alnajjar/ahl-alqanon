        ...
        <body>
            ...
            <div class="container mt-5" style="direction: rtl;">
                ...
                <form method="post" class="shadow p-3 mt-5 form-w" action="">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-4">
                            ...
                            <input type="text" class="form-control"
                                value="<?= $document['client_first_name'] . ' ' . $document['client_last_name'] ?>" disabled>
                    ...
                    <?php endif; ?>
                    <div style="text-align: justify; overflow-x: auto; width:100%; scrollbar-width: thin;max-height: 600px;"
                        id="editor2" class="mt-3">
                        <div class="document-title"><?= $document['title'] ?></div>
                        <?= $document['content'] ?>
                    </div>
                    <div style="display:none;">
                        <div style="text-align: justify; overflow-x: auto; width:100%; scrollbar-width: thin;" id="editor"
                            class="mt-3">
                            <div class="document-title"><?= $document['title'] ?></div>
                            <?= $document['content'] ?>
