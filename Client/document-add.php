...
<div class="container mt-5">
    ...
    <form method="post" class="shadow p-3 form-w" action="req/document-add.php" enctype="multipart/form-data" id="documentForm">
                    ...
                    if (!empty($user_id)) {
                        ...
                        if (count($cases) > 0) {
                            foreach ($cases as $case) {
                                ...
                                echo "<option value='$case_id'>$case_title</option>";
                            }
                        } else {
                            echo "<option value=''>لا توجد قضايا مرتبطة بك</option>";
                        }
                    } else {
        ...
        <input type="hidden" name="lawer_name" id="lawers" value="<?=$lawyer_id?>">
            <input type="hidden" name="client_name" id="client_name" value="<?=$user_id?>">
