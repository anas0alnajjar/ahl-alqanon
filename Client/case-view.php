    ...
    <form class="" method="POST" action="" enctype="multipart/form-data" id="formEdit">
        ...
        <?php
            ...
            <ul class="nav nav-tabs" id="myTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="expay-info-tab" data-bs-toggle="tab" data-bs-target="#expay-info" type="button" role="tab" aria-controls="" aria-selected="true">التفاصيل المالية</button>
                </li>
                <?php endif; ?>
                                ...
                                <div class="column" style="min-width:25%">
                                    <div class="row">
                                        <?php if ($pages['clients']['read']) : ?>
                                            <button style="text-align: right;" id="editClientBtn" type="button" class="btn btn-link clients">المعلومات الشخصية</button>
                                        <?php endif; ?>
                                            ...
                                            <div id="dynamic_cards_payment" class="row">
                                                ...
                                                foreach ($payments as $index => $payment) {
                                                                ...
                                                                <div id="' . $collapseIdPay . '" class="collapse" data-parent="#dynamic_cards_payment">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="form-group form-check mt-2">
                                                                            ...
                                                                            <label for="received' . htmlspecialchars($payment["id"]) . '" class="form-check-label">تم دفعها</label>
                                                                        </div>
                                                    ...
                                                    if ($payment['received'] !== 1) {
                                                        echo '<button style="min-width:100%" type="button" class="btn btn-danger btn-sm deletePayment payments-delete" data-payment-id="' . htmlspecialchars($payment["id"]) . '">حذف</button>';
                                                    } else {
