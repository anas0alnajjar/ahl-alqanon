                    ...
                    <div class="container">
                        <form action="" method="POST">
                            <div class="form-container col-md-12 mx-auto">
                                <h2 class="form-title">عرض الباقة</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control" id="planDescription" name="plan_description" rows="2" value="<?= $package['description'] ?>" disabled></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="planStatus" name="plan_status">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="planPrice" name="plan_price" placeholder="أدخل سعر الباقة" required>
                                    </div>
                                    <div class="form-group col-md-6">
