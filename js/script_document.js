                    ...
                    $('#records').DataTable({
                        ...
                        "columns": [
                            ...
                            },
                            {
                                ...
                                "render": function(data, type, row, meta) {
                                    return `
                                        <button class="btn btn-warning btn-sm" onclick="editDocument(${row.document_id})">تعديل</button>
                                        <button class="btn btn-danger btn-sm" onclick="deleteDocument(${row.document_id})">حذف</button>
                                    `;
                                }
                            }
                        ]
