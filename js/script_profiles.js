            ...
            $('#records').DataTable({
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row, meta) {
                            return `
                                <button class="btn btn-primary btn-sm" onclick="copyLink(${row.id})">نسخ الرابط</button>
                                <button class="btn btn-warning btn-sm" onclick="editProfile(${row.id})">تعديل</button>
                                <button class="btn btn-danger btn-sm" onclick="deleteProfile(${row.id})">حذف</button>
                            `;
                        }
                    }
                ]
