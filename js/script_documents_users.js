...
function fetch(start_date, end_date) {
    $.ajax({
        ...
        success: function(data) {
            ...
            // التحقق من وجود المتغير hideingColumn وقيمته
            if (typeof hideingColumn === 'undefined' || hideingColumn != 1) {
                columns.push({
                    "data": "lawyer_name",
                    "title": "اسم المحامي"
                });
            ...
            columns.push(
                {
                    "data": null, // استخدم null هنا لتحديد أن القيمة سيتم حسابها
                    "title": "اسم الموكل",
                    "render": function (data, type, row) {
                        // قم بجمع الاسم الأول والاسم الأخير هنا
