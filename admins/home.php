...
if (isset($_SESSION['user_id']) && 
    ...
    if ($_SESSION['role'] == 'Admins') {
        ...
        $tables = array(
            ...
            'message' => array('label' => 'الرسائل', 'icon' => 'fa-envelope', 'Furl' => 'message.php'),
        ...
        <div class="col lawyers">
            ...
            <a href="lawyers.php">
                <div class="card-body">
                    ...
                    <h5 class="card-title">المحامين</h5>
                    <span class="badge bg-secondary rounded-pill">
                        <i class="fas fa-user-tie"></i> <?=$tableCounts['lawyer']?> محامين
                    </span>
                </div>
                </a>
            </div>
            ...
            <a href="message.php">
                <div class="card-body">
                    ...
                    <span class="badge bg-warning rounded-pill">
                        <i class="fas fa-envelope"></i> <?=$tableCounts['message']?> رسالة 
                    </span>
                </div>
                </a>
            </div>
            ...
            <a href="requests.php">  
              <div class="card-body">
                    ...
                    <span class="badge bg-danger rounded-pill">
                        <i class="fas fa-user-plus"></i> <?=$tableCounts['ask_join']?> طلبات انضمام
                    </span>
                </div>
                </a>
            </div>
