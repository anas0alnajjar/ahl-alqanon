...
<body>
    ...
    <div class="container mt-5">
        <div class="btn-group mb-3" style="direction:ltr;">        
            <a href="users.php" class="btn btn-secondary user_management">إدارة المستخدمين</a>  
            <a href="managers.php" class="btn btn-dark">المدراء</a>
        </div>
        <div class="row">
            <div class="col-md-8">
            <form method="post" class="shadow p-3 form-w" action="req/manager-edit.php">
                    <h3>تعديل معلومات المدير</h3><hr>
                    ...
                    <div class=" row mb-3">
                        <div class="col-md-6">
                            ...
                            <option value="" disabled selected>اختر الدور</option>
                                <?php
                                    ...
                                    $role_id = $manager['role_id']; // معرف الدور الخاص بالمدير
                                    ...
                                    if (!empty($offices)) {
                                        ...
                                        $sql_roles = "SELECT `power_id`, `role` FROM powers WHERE office_id IN ($office_ids) OR default_role_manager = 1";
                        ...
                        <label class="form-label">المكتب</label>
                            ...
                            <?php
                                $admin_id = $_SESSION['user_id']; // معرف الآدمن الحالي
                                $office_id = $manager['office_id']; // معرف المكتب الخاص بالمدير
                                ...
                                if ($stmt_offices->rowCount() > 0) {
                                    ...
                                    echo "<option value='' disabled>لا توجد مكاتب متاحة</option>";
                                }
                            ?>
                    ...
                    <div class="form-check custom-checkbox mb-3">
                        <input type="checkbox" class="form-check-input" id="stop" name="stop" <?php if($manager['stop'] == 1) echo 'checked'; ?> value="1">
