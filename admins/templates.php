        ...
        <div class="modal-content" style="max-height:500px;overflow:auto;">
            ...
            <div class="modal-body">
                <form id="messageFormDues" method="post">
                    <div class="form-group">
                        <label class="form-label">المكتب</label>
                        <select id="office_idDues" class="form-control" name="office_id">
                            <option value=""  selected>اختر المكتب</option>
                            <?php
        ...
        <div class="modal-content" style="max-height:500px;overflow:auto;">
            ...
            <div class="modal-body">
                <form id="messageFormPhone" method="post">
                    <div class="form-group">
                        <label class="form-label">المكتب</label>
                        <select id="office_idPhone" class="form-control" name="office_id">
                            <option value=""  selected>اختر المكتب</option>
                            <?php
        ...
        <div class="modal-content" style="max-height:500px;overflow:auto;">
            ...
            <div class="modal-body">
                <form id="messageFormDuesPhone" method="post">
                    <div class="form-group">
                        <label class="form-label">المكتب</label>
                        <select id="office_idDuesPhone" class="form-control" name="office_id">
                            <option value=""  selected>اختر المكتب</option>
                            <?php
...
<div class="modal fade" id="editMessageModalDuesPhones" tabindex="-1" aria-labelledby="editMessageModalLabelDues" aria-hidden="true">
    ...
    <script src="../js/script_templates_users.js"></script>
