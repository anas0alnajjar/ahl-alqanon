...
<body>
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="role_id" class="form-select" name="role_id">
                                ...
                                <?php
                                    ...
                                    $sql_default_role = "SELECT power_id FROM powers WHERE default_role_lawyer = 1 LIMIT 1";
                                    ...
                                    if (!empty($offices)) {
                                        ...
                                        $sql_roles = "SELECT `power_id`, `role` FROM powers WHERE office_id IN ($office_ids) OR default_role_lawyer = 1";
    ...
    document.getElementById('lawyerForm').addEventListener('submit', function(event) {
        ...
        var requiredFields = [
            ...
            { name: 'address', message: 'يرجى ملء حقل العنوان.' },
            ...
            { name: 'city', message: 'يرجى ملء حقل المدينة.' },
