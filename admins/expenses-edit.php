...
<head>
	...
	<title>Admin - Edit Expenses</title>
                            ...
                            <?php
                                       ...
                                       if ($stmt->rowCount() > 0) {
                                           foreach ($result as $row) {
                                               $id = $row["office_id"];
                                               $exp_id = $exp['office_id'];
                                               $office_name = $row["office_name"];
                                               $selectedOffice = ($id == $exp_id) ? "selected" : "";
                                               echo "<option value='$id' aria-label='$office_name' $selectedOffice>$office_name</option>";
                                           }
                                       } else {
